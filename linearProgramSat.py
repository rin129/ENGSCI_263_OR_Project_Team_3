...
# "zero demand" is a list that contains the index position of all of the stores not to be visited. 

def linearProgramSat(routes, hours, stores, zero_demand):
    ...
    # Remove the names of stores that have zero demands and so don't need to be visited thus are not variables in the linear program. 
